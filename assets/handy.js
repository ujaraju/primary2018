  ...
  createClass(PxsMap, [{
    ...
    value: function _createMap() {
      ...
      return this.geolocate().done(function (results) {
        ...
        google.maps.event.addDomListener(window, 'resize', justDebounce$1(_this2.resize, 250, true, true));
      }).fail(function (status) {
...
if ( typeof undefined === 'function' && undefined.amd ) {
  // AMD for RequireJS
  undefined( [ 'get-style-property/get-style-property' ], defineGetSize );
} else {
  // CommonJS for Component
...
if ( typeof undefined === 'function' && undefined.amd ) {
  // AMD
  undefined( [ 'eventie/eventie' ], defineDocReady );
} else {
...
var js$1 = createCommonjsModule(function (module, exports) {
/*!
 * Flickity v1.2.1
...
jquery$1(window).on('dragStart', function (event) {
  ...
  if ($flickityEnabledEl.length) {
    var flickity = js$1.data($flickityEnabledEl.get(0));
  ...
  createClass$2(RTE, [{
    ...
    value: function _init() {
      ...
      this.$rteContainers.each(function (index, rteContainer) {
        _this.groupedContents.push(new dist$1(rteContainer, { layout: 'accordion', intelliparse: false }));
      });
    }
  }]);
  return RTE;
...
var Sections = function () {
  function Sections() {
    classCallCheck$2(this, Sections);
...
var NavTrigger = function () {
  function NavTrigger() {
    ...
    classCallCheck$2(this, NavTrigger);
  ...
  createClass$2(NavTrigger, [{
    ...
    value: function show(force) {
      ...
      jquery$1(this.selector).attr('aria-expanded', true);
...
var justDebounce$2 = debounce$1;

function debounce$1 (fn, delay, at_start, guarantee) {
  var timeout;
  var args;
  var self;
  ...
  createClass$2(Map, [{
    ...
    value: function createMap() {
      ...
      return this.geolocate().done(function (results) {
        ...
        google.maps.event.addDomListener(window, 'resize', justDebounce$2(_this.resize, 250, true, true));
      }).fail(function (status) {
        var usageLimits = 'https://developers.google.com/maps/faq#usagelimits';
        var errorMessage = void 0;
...
var ContactbarStaticSection = function () {
  function ContactbarStaticSection(section) {
    ...
    classCallCheck$2(this, ContactbarStaticSection);
  ...
  createClass$2(ContactbarStaticSection, [{
    key: 'onSectionUnload',
    value: function onSectionUnload() {
...
var BlogLayout = function () {
  function BlogLayout(el) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    classCallCheck$2(this, BlogLayout);
  ...
  createClass$2(BlogLayout, [{
    ...
    value: function _initFlickity() {
      ...
      this.flickity = new js$1(this.$el[0], {
        cellAlign: 'left',
...
var DynamicBlogPosts = function () {
  function DynamicBlogPosts(section) {
    classCallCheck$2(this, DynamicBlogPosts);
  ...
  createClass$2(DynamicBlogPosts, [{
    key: 'onSectionUnload',
    value: function onSectionUnload() {
...
var CurrencyConverter = function () {
  function CurrencyConverter() {
    classCallCheck$3(this, CurrencyConverter);
  ...
  createClass$3(CurrencyConverter, [{
    key: 'init',
    ...
    value: function _unbindEvents() {
      ...
      try {
        for (var _iterator2 = this.currentState.buttons[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          jquery$1(button.selector, this.$el).off('click.menu');
        }
      } catch (err) {
...
var Quantity = function () {
  function Quantity(el) {
    ...
    classCallCheck$2(this, Quantity);
...
var ProductOptions = function () {
  function ProductOptions(product) {
    classCallCheck$2(this, ProductOptions);
...
var VariantHelper = function () {
  function VariantHelper(product, $variants, $options) {
    classCallCheck$2(this, VariantHelper);
...
var ProductForm = function () {
  ...
  function ProductForm(el) {
    ...
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    classCallCheck$2(this, ProductForm);

    this.$el = jquery$1(options.container || el);
    this.$form = jquery$1(options.form || el);
    this.options = options;
    ...
    // Switch variant
    jquery$1(window).on('product-variant-switch.product-form-' + this.product.id, function (event, data) {
  ...
  createClass$2(ProductForm, [{
    key: 'unload',
    value: function unload() {
      var _this2 = this;

      this.events.forEach(function ($el) {
        return $el.off('.product-form-' + _this2.product.id);
      });
    ...
    value: function _changeVariant(data) {
      ...
      // Compare at price
      this.$el.find('[data-variant-compare-at-price]').toggleClass('money-compare-at-hidden', !variant.compare_at_price || variant.price === variant.compare_at_price).text(Shopify.formatMoney(variant.compare_at_price, format)).each(function (index, el) {
...
var ProductMenu = function () {
  function ProductMenu($el, data, postMessage, inQuickshop) {
    ...
    classCallCheck$2(this, ProductMenu);
...
var ProductQuickshop = function () {
  function ProductQuickshop($parent, $el, postMessage) {
    classCallCheck$2(this, ProductQuickshop);

    this.$parent = $parent;
    this.$el = $el;
    this.postMessage = postMessage;
    this.$details = jquery$1('[data-product-quickshop-details]', this.$el);
  ...
  createClass$2(ProductQuickshop, [{
    key: '_init',
    value: function _init() {
      var $priceEl = jquery$1('[data-variant-price]', this.$details);
      var $compareAtPriceEl = jquery$1('[data-variant-compare-at-price]', this.$details);

      dist$2.update($priceEl.get(0));
      dist$2.update($compareAtPriceEl.get(0));
    ...
    value: function _bindOnOpen() {
      ...
      jquery$1(window).on('product-variant-switch.product-quickshop', justDebounce$2(function (event, data) {
    ...
    value: function _switchVariant(event, data) {
      ...
      // Compare at price
      jquery$1('[data-variant-compare-at-price]', this.$details).toggleClass('money-compare-at-hidden', !variant.compare_at_price).text(Shopify.formatMoney(variant.compare_at_price, this.data.money_format)).each(function (index, el) {
        return dist$2.update(el);
      });

      // Price
      jquery$1('[data-variant-price]', this.$details).text(Shopify.formatMoney(variant.price, this.data.money_format)).each(function (index, el) {
        return dist$2.update(el);
      });
...
var ProductItem = function () {
  function ProductItem($el, postMessage) {
    classCallCheck$2(this, ProductItem);
...
var ProductHighlights = function () {
  function ProductHighlights($el, postMessage) {
    classCallCheck$2(this, ProductHighlights);
  ...
  createClass$2(ProductHighlights, [{
    key: '_bindEvents',
    value: function _bindEvents() {
    ...
    value: function _initFlickity() {
      if (!this.flickity) {
        this.flickity = new js$1(this.$productHighlightsNormal[0], {
...
var DynamicFeaturedProducts = function () {
  function DynamicFeaturedProducts(section) {
    classCallCheck$2(this, DynamicFeaturedProducts);
  ...
  createClass$2(DynamicFeaturedProducts, [{
    key: 'onSectionUnload',
    value: function onSectionUnload() {
  ...
  createClass$2(DynamicInstagram, [{
    ...
    value: function _renderPhotos(photos) {
      ...
      photos.forEach(function (photo) {
        var $photo = _this2.$photoTemplate.clone();
        ...
        var timestamp = date.toLocaleDateString(_this2.settings.locale, dateOptions);
        var caption = photo.caption && photo.caption.text ? photo.caption.text : '';

        var standard = photo.images.standard_resolution;
        var scale = standard.width > standard.height ? 'y' : 'x';

        var $image = jquery$1('\n        <a class="instagram-link" target="_blank" href="' + photo.link + '"></a>\n        <img\n          class="instagram-image instagram-image-scale-' + scale + '"\n          src="' + standard.url + '"\n        />\n      ');

        $photo.removeClass('instagram-photo-template').removeAttr('data-instagram-photo-template');

        $photo.find('[data-instagram-photo-template-likes]').append(likes).removeAttr('data-instagram-photo-template-likes');

        if (caption !== '') {
          $photo.find('[data-instagram-photo-template-caption]').append(caption).removeAttr('data-instagram-photo-template-caption');
        }

        $photo.find('[data-instagram-photo-template-timestamp]').append(timestamp).removeAttr('data-instagram-photo-template-timestamp');

        $photo.find('[data-instagram-photo-template-photo]').append($image).removeAttr('data-instagram-photo-template-photo');

        photoArray.push($photo);
      });

      this.$contentPlaceholder.fadeOut().promise().done(function () {
...
var DynamicSlideshow = function () {
  ...
  createClass$2(DynamicSlideshow, [{
    ...
    value: function _initFlickity() {
      ...
      js$1.prototype.setGallerySize = function setGallerySize() {
        if (this.options.setGallerySize) {
      ...
      var originalSelect = js$1.prototype.select;
      js$1.prototype.select = function select() {
...
var VimeoPlayer$1 = function () {
  function VimeoPlayer(el) {
    classCallCheck$2(this, VimeoPlayer);
...
var DynamicVideo = function () {
  function DynamicVideo(section) {
    ...
    if (videoEl) {
      this.video = new Video(section.el.querySelector('[data-video]'));
    }
  }
...
var GiftCardStaticSection = function () {
  function GiftCardStaticSection(section) {
    classCallCheck$2(this, GiftCardStaticSection);
  ...
  createClass$2(GiftCardStaticSection, [{
    key: 'onSectionUnload',
    value: function onSectionUnload() {
      this.qrcode = null;
    }
...
var MeganavMenu = function () {
  function MeganavMenu(el) {
    ...
    classCallCheck$2(this, MeganavMenu);
...
var MobileNav = function () {
  function MobileNav(el) {
    ...
    classCallCheck$2(this, MobileNav);
    ...
    this.$megaNavTriggers.each(function (key, megaNavTrigger) {
      var $megaNavTrigger = jquery$1(megaNavTrigger);
      var $megaNav = $megaNavTrigger.children('.meganav');
      _this.megaNavs.push(new MeganavMenu($megaNav.get(0)));
    });

    this.events = [];
  }

  createClass$2(MobileNav, [{
    key: 'unload',
    value: function unload() {
      this.close();
      this.$el.off('.navmenu');
...
var NavDesktop$1 = function () {
  function NavDesktop(el, postMessage) {
    ...
    classCallCheck$2(this, NavDesktop);
  ...
  createClass$2(NavDesktop, [{
    ...
    value: function openItem(el) {
      ...
      // Adjust menu position if it runs off the screen
      $el.toggleClass('navmenu-adjust-right', el.getBoundingClientRect().right + el.clientWidth * 1.5 > window.innerWidth);
    ...
    value: function closeItem(el) {
      ...
      jquery$1(el).attr('aria-expanded', false);
...
var FadePanel = function () {
  function FadePanel(el) {
    classCallCheck$2(this, FadePanel);
...
var Meganav = function () {
  function Meganav(el, postMessage, trigger) {
    ...
    classCallCheck$2(this, Meganav);

    this.$el = jquery$1(el);
    this.$window = jquery$1(window);
    this.namespace = 'mega-nav-' + trigger;
    ...
    this.$window.on('resize.' + this.namespace, function () {
      return _this.update();
    });
...
var HeaderStaticSection = function () {
  function HeaderStaticSection(section) {
    ...
    classCallCheck$2(this, HeaderStaticSection);
    ...
    this.$megaNavTriggers = jquery$1(this.$el.find('.site-navigation')).find('[data-meganav-trigger]');
    this.$megaNavs = this.$el.find('[data-meganav]');
    this.megaNavs = [];
    ...
    this.$megaNavTriggers.each(function (key, megaNavTrigger) {
      ...
      var $megaNav = _this.$megaNavs.filter('[data-meganav="' + trigger + '"]');
      _this.megaNavs.push(new Meganav($megaNav.get(0), _this.section.postMessage, trigger));
    });
    ...
    }), jquery$1(window).on('resize.header', justDebounce$2(function () {
  ...
  createClass$2(HeaderStaticSection, [{
    key: '_repositionNav',
...
var MobileCollectionsDynamicSection = function () {
  function MobileCollectionsDynamicSection(section) {
    classCallCheck$2(this, MobileCollectionsDynamicSection);

    this.$el = jquery$1(section.el);
    this.menu = new MeganavMenu(this.$el);
  }

  createClass$2(MobileCollectionsDynamicSection, [{
    key: 'onSectionUnload',
    value: function onSectionUnload() {
      this.menu.unload();
    }
...
var ProductZoom = function () {
  function ProductZoom(el) {
    classCallCheck$2(this, ProductZoom);
  ...
  createClass$2(ProductZoom, [{
    ...
    value: function _bindEvents() {
      ...
      jquery$1(window).on('resize.product-zoom', this.resetZoom);
    }
  }, {
    key: '_unbindEvents',
    value: function _unbindEvents() {
      this.$el.off('click.product-zoom');
      jquery$1(window).off('resize.product-zoom', this.resetZoom);
    }
  }, {
    ...
    value: function _toggleZoom(clientX, clientY) {
      ...
      if (!this.zoomed) {
        this.$el.on('mousemove.product-zoom', justDebounce$2(function (event) {
...
var ProductImages = function () {
  function ProductImages(el, options) {
    var _this = this;

    classCallCheck$2(this, ProductImages);

    this.el = el;
    this.imagesLayout = options.images_layout;
    this.navigateToImages = options.navigateToImages;
    this.imageLoadCallback = options.imageLoadCallback;

    this.imagesContainer = el.querySelector('[data-product-images]');
    this.images = el.querySelectorAll('[data-product-image]');
    this.imagesCount = this.images.length;

    this.zoomableImages = el.querySelectorAll('[data-product-image-zoom]');
    this.zoomableImagesCount = this.zoomableImages.length;
    this.onZoomableImagesLoaded = this._onZoomableImagesLoaded.bind(this);

    this.zoomedImages = [];

    // Handle image loads
    if (this.imagesCount > 0) {
      this.imagesLoaded = new imagesloaded$1(this.images);
      this.imagesLoaded.on('progress', this.imageLoadCallback);
    }

    // Handle image zooms
    if (this.zoomableImagesCount > 0) {
      this.zoomableImagesLoaded = new imagesloaded$1(this.zoomableImages);
      this.zoomableImagesLoaded.on('done', this.onZoomableImagesLoaded);
    }

    this.scrollUpButton = this.el.querySelector('[data-product-images-scroll-up]');
    this.scrollDownButton = this.el.querySelector('[data-product-images-scroll-down]');

    this.onThumbnailClick = this._onThumbnailClick.bind(this);
    this.onScrollClickUp = function () {
      return _this._scrollVerticalImages('up');
    };
    this.onScrollClickDown = function () {
      return _this._scrollVerticalImages('down');
    };

    // Handle layout changes
    this.onLayoutChange = this._adjustLayout.bind(this);
  ...
  createClass$2(ProductImages, [{
    ...
    key: 'selectImageByVariant',
    value: function selectImageByVariant(variant) {
      if (!variant) return;
      ...
      if (!variant.featured_image) {
        ...
        var image = this.el.querySelector('[data-product-image-id="' + variant.featured_image.id + '"]');

        this.selectImage(image);

        if (this.imagesLayout === 'standard') {
    ...
    value: function selectImage() {
      ...
      var selectableImage = this.el.querySelector('[data-product-selected-image]');

      // Change slideshow slide if we are in mobile
      if (image && this.flickity) {
        var index = image.getAttribute('data-product-image-index');
      ...
      if (!image) {
        var defaultId = selectableImage.getAttribute('data-product-selected-image-default');

        image = this.el.querySelector('[data-product-image-id="' + defaultId + '"]');
      }

      for (var i = 0; i < this.images.length; i++) {
        this.images[i].classList.remove('product-image-selected');
      }

      image.classList.add('product-image-selected');

      selectableImage.innerHTML = image.innerHTML;
    }
  }, {
    key: 'unload',
    value: function unload() {
      ...
      if (this.imagesLoaded) {
        this.imagesLoaded.off(this.imageLoadCallback);
      }

      if (this.zoomableImagesLoaded) {
        this.zoomableImagesLoaded.off(this.onZoomableImagesLoaded);
        this.zoomedImages.forEach(function (zoomedImage) {
          return zoomedImage.unload();
        });
      }
    }
  }, {
    key: '_onZoomableImagesLoaded',
    value: function _onZoomableImagesLoaded() {
      for (var i = 0; i < this.zoomableImages.length; i++) {
        this.zoomedImages.push(new ProductZoom(this.zoomableImages[i]));
      }
    }
  }, {
    key: '_adjustLayout',
    value: function _adjustLayout() {
      if (layout.isBreakpoint('L')) {
        if (this.flickity) {
          this._destroyFlickity();
        }

        if (this.imagesLayout === 'alternate') {
          this._initThumbnails();
        }
      } else if (layout.isBreakpoint('S', 'M')) {
        if (this.imagesLayout === 'alternate') {
          this._destroyThumbnails();
        }

        if (!this.flickity && this.images.length >= 2) {
          this._initFlickity();
        }
      }
    }
    ...
    value: function _initFlickity() {
      ...
      var selectFn = js$1.prototype.select;
      js$1.prototype.select = function select() {
        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }

        selectFn.apply(this, args);
        if (this.options.adaptiveHeight) {
          this.setGallerySize();
        }
      };

      this.flickity = new js$1(this.imagesContainer, {
        accessibility: true,
        adaptiveHeight: true,
        cellAlign: 'left',
    ...
    value: function _initThumbnails() {
      ...
      this.scrollUpButton.addEventListener('click', this.onScrollClickUp);
      this.scrollDownButton.addEventListener('click', this.onScrollClickDown);

      for (var i = 0; i < this.images.length; i++) {
        this.images[i].addEventListener('click', this.onThumbnailClick);
      }
    }
  }, {
    key: '_destroyThumbnails',
    value: function _destroyThumbnails() {
      if (!this.scrollUpButton || !this.scrollDownButton) {
        return;
      }

      this.scrollUpButton.removeEventListener('click', this.onScrollClickUp);
      this.scrollDownButton.removeEventListener('click', this.onScrollClickDown);

      for (var i = 0; i < this.images.length; i++) {
        this.images[i].removeEventListener('click', this.onThumbnailClick);
      }
    }
  }, {
    ...
    key: '_scrollVerticalImages',
    value: function _scrollVerticalImages(direction) {
      var imagesContainerTop = this.imagesContainer.getBoundingClientRect().top;
      ...
      for (var i = 0; i < this.images.length; i++) {
        ...
        var distance = Math.floor(Math.abs(imagesContainerTop - (direction === 'up' ? bottom : top)));
      ...
      var $imagesContainer = jquery$1(this.imagesContainer);
      var navigateToImage = direction === 'up' ? this.images[Math.max(closestIndex - 1, 0)] : this.images[Math.min(closestIndex + 1, this.images.length - 1)];
      var navigateToImageDistance = navigateToImage.getBoundingClientRect().top - imagesContainerTop;

      $imagesContainer.animate({
        scrollTop: this.imagesContainer.scrollTop + navigateToImageDistance
      }, { queue: false, duration: 500 });
    }
  }, {
    key: '_highlightImage',
    value: function _highlightImage(image) {
      var _this2 = this;

      // Move image to top if we are not in sticky mode
      if (!this.navigateToImages) {
        this.imagesContainer.insertBefore(image, this.images[0]);
        this.images = this.el.querySelectorAll('[data-product-image]');
      }

      // Fade out non-selected images
      for (var i = 0; i < this.images.length; i++) {
        if (image !== this.images[i]) {
          this.images[i].classList.add('product-image-fade');
        }
      }

      // Scroll to selected image
      var scrollTop = image.offsetTop;

      jquery$1('html,body').animate({ scrollTop: scrollTop }, 'slow', 'swing', function () {
        // Fade back in all the images
        setTimeout(function () {
          for (var _i = 0; _i < _this2.images.length; _i++) {
            _this2.images[_i].classList.remove('product-image-fade');
          }
        }, 333);
      });
    }
...
var ProductDetails = function () {
  function ProductDetails($el, section) {
    ...
    classCallCheck$2(this, ProductDetails);
    ...
    // Alert
    this.$alert = jquery$1('.product-alert', $el);

    this.productImages = new ProductImages(this.$el[0], {
      images_layout: section.data.images_layout,
      navigateToImages: false,
      imageLoadCallback: this.positionDetails
    });

    // Form
    if (!this.onboarding && this.data.form_is_inline) {
      this.form = new ProductForm(this.$el.find('[data-product-details]'), {
  ...
  createClass$2(ProductDetails, [{
    key: 'selectImageByVariant',
    value: function selectImageByVariant(variant) {
      this.productImages.selectImageByVariant(variant);
    }
  }, {
    key: 'unload',
    value: function unload() {
    ...
    value: function _positionDetails() {
      ...
      this.productImages.setOptions({ navigateToImages: isSticky });
...
var SearchStaticSection = function () {
  function SearchStaticSection(section) {
    ...
    classCallCheck$2(this, SearchStaticSection);
  ...
  createClass$2(SearchStaticSection, [{
    key: 'onSectionUnload',
    value: function onSectionUnload() {
      this.blogLayout.unload();
      this.events.forEach(function ($el) {
...
var StaticArticle = function () {
  function StaticArticle(section) {
    ...
    var el = section.el;
    this.$articleWrapper = jquery$1('[data-article-wrapper]', el);
    this.$articleImage = jquery$1('[data-article-image]', el);

    this._positionImage();

    jquery$1(window).on('resize.article', function () {
      return _this._positionImage();
    });
  }

  createClass$2(StaticArticle, [{
    key: '_positionImage',
    ...
    key: 'onSectionUnload',
    value: function onSectionUnload() {
      jquery$1(window).off('resize.article');
    }
  }]);
...
var StaticBlog = function () {
  function StaticBlog(section) {
    classCallCheck$2(this, StaticBlog);

    this.$articles = jquery$1('[data-article-excerpts]', section.el);
    this.blogLayout = new BlogLayout(this.$articles);
  }

  createClass$2(StaticBlog, [{
    key: 'onSectionUnload',
    value: function onSectionUnload() {
      this.blogLayout.unload();
    }
...
var StaticCart = function () {
  function StaticCart(section) {
    ...
    this.$el.find('[data-quantity]').each(function (index, el) {
      ...
      jquery$1(quantity.input).on('change.cart', justDebounce$2(function (event) {
    ...
    // Bind events
    this.events = [this.$cartItemButtonDismiss.on('click.cart', function (event) {
      var $cartItem = jquery$1(event.currentTarget).closest('[data-cart-item]');
      var variantID = $cartItem.data('cart-item-variant-id');

      _this._removeFromCart($cartItem, variantID);
    }), this.$shippingToggle.on('click.cart', function (event) {
      event.preventDefault();
  ...
  createClass$2(StaticCart, [{
    ...
    value: function _toggleInlineShippingCalculator() {
      // Toggle form
      this.$shippingFieldsInline.toggle();
    ...
    value: function _removeFromCart($cartItem, variantID) {
      ...
      this._updateCart(variantID, 0).done(function (response) {
        ...
        if (response.item_count == 0) {
          _this2.$cartMenuContainer.slideUp();
          jquery$1('[data-cart-form]').slideUp(function () {
            jquery$1('[data-cart-empty-message]', _this2.$el).show();
          });
        } else {
        ...
        _this2.postMessage('product:add-to-cart', { response: response });

        jquery$1('[data-cart-subtotal]', _this2.$el).text(Shopify.formatMoney(response.original_total_price, _this2.data.money_format)).each(function (index, el) {
          return dist$2.update(el);
        });
      });
    }
...
var StaticSection = function () {
  function StaticSection(section) {
    ...
    classCallCheck$2(this, StaticSection);
    ...
    this.selectedCollectionTags = this.useHistory ? this.data.current_tags : [];
  ...
  createClass$2(StaticSection, [{
    ...
    value: function _onFilterChange(value) {
      this.selectedCollectionTags = [value];
    ...
    value: function onSectionUnload() {
      ...
      try {
        for (var _iterator3 = this.productItems[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
//# sourceMappingURL=handy.js.map?1521153821498
